<?php
    ...
    class Template extends Response {
         ...
         * @return Dart\View\Template\Block
         */
        ...
        public function fileName($template = null) {
            if(null === $template) $template = $this->file();
         ...
         * @throws Dart\View\Exception\TemplateMissing
         * @return boolean
         */
        public function exists($throw = false) {
            // Avoid multiple file_exists checks
            if($this->_exists) return true;
