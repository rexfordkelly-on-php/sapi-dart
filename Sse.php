<?php
     ...
     *
     * Extends the Response class to be able to handle iterable
     * (list, or array-like) lists of events.
     * 
    ...
    class Sse extends Response {
        ...
        protected function _sendEvent(array $event, $buff = '') {
